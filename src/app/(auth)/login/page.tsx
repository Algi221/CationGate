          ...
          <div className="w-full max-w-115 mx-auto bg-white lg:bg-transparent p-4 sm:p-6 lg:p-0 rounded-2xl lg:rounded-none">
            <div className="mb-7 text-left">
              ...
              <p className="mt-2.5 text-xs sm:text-sm text-slate-500 font-medium leading-relaxed">
                ...
                <Link
                  href="/daftar"
                  className="font-bold text-[#0284C7] hover:text-[#0284C7] hover:underline transition-colors"
                >
                  Daftar sekarang
                </Link>
              </p>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="pt-1 flex items-center justify-between">
                ...
                <Link
                  ...
                  className="text-xs font-bold text-[#0284C7] hover:text-[#0284C7] hover:underline transition-colors"
                >
                  Lupa kata sandi?
                </Link>
              </div>
