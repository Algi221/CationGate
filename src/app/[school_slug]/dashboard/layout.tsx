...
import {
  ...
  Palette, Layers, Shield, Menu, ChevronDown, UserCircle, ShieldCheck, Lock, CreditCard, User, Search
} from "lucide-react";
  ...
  const menuStructure = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: `/${schoolSlug}/dashboard/settings`, icon: <Settings size={18} />, label: "Pengaturan", lockedIfUnverified: true }
      ]
    }
  ];
