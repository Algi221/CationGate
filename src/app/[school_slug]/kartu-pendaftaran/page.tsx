...
export default function KartuPendaftaranPage({
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-950 py-8 px-4 sm:px-6">
      ...
      {/* Printable Card Area */}
      <div id="printable-card" className="max-w-4xl mx-auto bg-white text-slate-900 rounded-2xl shadow-xl p-8 sm:p-10 border border-slate-200">
        ...
        <div className="flex items-center justify-between pb-6 border-b-2 border-slate-800 mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-600 font-medium">Sistem Penerimaan Murid Baru (SPMB) • Tahun Ajaran {applicant.periode || "2026/2027"}</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="space-y-3">
            <h3 className="text-xs font-bold uppercase text-slate-500 tracking-wider pb-1 border-b border-slate-200">Data Calon Siswa</h3>
            ...
            <div className="flex justify-between py-1.5 border-b border-slate-100 text-xs">
              <span className="font-medium text-slate-500">Sekolah Asal</span>
              <span className="font-medium text-slate-900">{applicant.sekolah_asal}</span>
            </div>
          </div>

          <div className="space-y-3">
            <h3 className="text-xs font-bold uppercase text-slate-500 tracking-wider pb-1 border-b border-slate-200">Program & Status</h3>
            
            <div className="flex justify-between py-1.5 border-b border-slate-100 text-xs">
              <span className="font-medium text-slate-500">Program Keahlian</span>
              <span className="font-bold text-blue-700">{applicant.jurusan_1}</span>
            </div>
            
            <div className="flex justify-between py-1.5 border-b border-slate-100 text-xs">
              <span className="font-medium text-slate-500">Tanggal Pendaftaran</span>
            ...
            <div className="flex justify-between py-1.5 border-b border-slate-100 text-xs">
              <span className="font-medium text-slate-500">Status Pendaftaran</span>
              <span className="font-bold text-amber-600">{applicant.status}</span>
            </div>

            <div className="flex justify-between py-1.5 border-b border-slate-100 text-xs">
              <span className="font-medium text-slate-500">Verifikasi Berkas Fisik</span>
        ...
        <div className="mb-8 border border-slate-300 rounded-xl p-5 bg-slate-50">
          ...
          <table className="w-full text-xs text-left border-collapse">
            <thead>
              <tr className="border-b border-slate-300 text-slate-700 font-bold bg-slate-200">
                <th className="py-2 px-3 w-12 text-center border-r border-slate-300">Cek</th>
            ...
            <tbody className="divide-y divide-slate-200">
              <tr>
                <td className="py-2.5 px-3 text-center font-mono border-r border-slate-200 text-slate-400">[ &nbsp; ]</td>
                <td className="py-2.5 px-3 font-semibold text-slate-800">Fotokopi Kartu Keluarga (KK)</td>
                <td className="py-2.5 px-3 text-slate-600">1 Lembar</td>
                <td className="py-2.5 px-3 border-l border-slate-200"></td>
              </tr>
              <tr>
                <td className="py-2.5 px-3 text-center font-mono border-r border-slate-200 text-slate-400">[ &nbsp; ]</td>
                <td className="py-2.5 px-3 font-semibold text-slate-800">Fotokopi KTP Orang Tua (Ayah &amp; Ibu)</td>
                <td className="py-2.5 px-3 text-slate-600">1 Lembar</td>
                <td className="py-2.5 px-3 border-l border-slate-200"></td>
              </tr>
              <tr>
                <td className="py-2.5 px-3 text-center font-mono border-r border-slate-200 text-slate-400">[ &nbsp; ]</td>
                <td className="py-2.5 px-3 font-semibold text-slate-800">Akta Kelahiran</td>
                <td className="py-2.5 px-3 text-slate-600">Asli &amp; 1 Fotokopi</td>
                <td className="py-2.5 px-3 border-l border-slate-200"></td>
              </tr>
              <tr>
                <td className="py-2.5 px-3 text-center font-mono border-r border-slate-200 text-slate-400">[ &nbsp; ]</td>
                <td className="py-2.5 px-3 font-semibold text-slate-800">Fotokopi Ijazah / Surat Keterangan Lulus (SKL)</td>
                <td className="py-2.5 px-3 text-slate-600">Legalisir 1 Lembar</td>
                <td className="py-2.5 px-3 border-l border-slate-200"></td>
              </tr>
              <tr>
                <td className="py-2.5 px-3 text-center font-mono border-r border-slate-200 text-slate-400">[ &nbsp; ]</td>
                <td className="py-2.5 px-3 font-semibold text-slate-800">Pas Foto Berwarna Terbaru (3x4)</td>
                <td className="py-2.5 px-3 text-slate-600">3 Lembar</td>
                <td className="py-2.5 px-3 border-l border-slate-200"></td>
              </tr>
            </tbody>
          </table>
        ...
        <div className="grid grid-cols-2 gap-8 pt-4 border-t border-slate-200 text-center">
          <div>
            <p className="text-xs text-slate-500 mb-1">Calon Siswa Pendaftar,</p>
            <div className="h-16"></div>
            <p className="text-xs font-bold underline text-slate-900">{applicant.nama}</p>
          </div>
          <div>
            <p className="text-xs text-slate-500 mb-1">Panitia Verifikasi SPMB,</p>
            <div className="h-16"></div>
