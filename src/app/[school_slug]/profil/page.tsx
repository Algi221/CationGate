...
export default function ProfilSekolahPublicPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 font-sans text-slate-800 dark:text-slate-100 selection:bg-blue-900 selection:text-white transition-colors duration-300">
      ...
      <header className="sticky top-0 z-50 w-full bg-white/90 dark:bg-[#0f172a]/90 backdrop-blur-md border-b border-slate-200 dark:border-slate-800">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center shrink-0 min-w-0">
            <Link
              href={`/${schoolSlug}`}
              className="flex items-center gap-3 overflow-visible group min-w-0"
            >
              <div className="relative h-10 w-10 shrink-0 overflow-visible">
                {ppdbLogo ? (
                  ...
                  <School className="w-full h-full text-blue-600" />
                )}
              </div>
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            >
              <button
                ...
                className="flex items-center gap-1 text-sm font-semibold text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors py-2"
              >
              ...
              {dropdownOpen && (
                <div className="absolute top-full left-0 w-48 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-xl flex flex-col gap-1">
                  <a
                    href="#sejarah"
                    className="px-4 py-2 text-xs font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
                  >
                    Sejarah Singkat
                  </a>
                  <a
          ...
          {/* Tombol Aksi Kanan (Dark Mode & Daftar) */}
          <div className="flex items-center gap-3 shrink-0">
            ...
            <Link
              ...
              className="hidden md:inline-flex items-center justify-center px-5 py-2 text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-full transition-colors whitespace-nowrap shadow-md"
            >
              Daftar
            </Link>
            ...
            <button
              ...
              className="flex lg:hidden items-center justify-center w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors border border-slate-200 dark:border-slate-700"
            >
      ...
      {/* Footer Minimalis */}
      <footer className="bg-[#0a1e3f] dark:bg-slate-900 text-slate-400 py-8 text-center text-xs space-y-1 transition-colors duration-300">
        <p className="text-white font-bold">{ppdbTitle}</p>
        <p>© 2026 All Rights Reserved • Powered by CationGate Tech Division.</p>
      </footer>
    </div>
  );
}
