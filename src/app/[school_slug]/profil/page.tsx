...
export default function ProfilSekolahPublicPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#020617] font-sans text-slate-800 dark:text-slate-200">
      
      {/* Navbar Minimalis */}
      <nav className="sticky top-0 z-50 w-full bg-white dark:bg-[#0f172a] border-b border-slate-200 dark:border-slate-800 h-16 flex items-center">
        <div className="max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="relative w-8 h-8 rounded-full overflow-hidden shrink-0 bg-slate-100 dark:bg-[#1e293b]">
      ...
      {/* Hero Profil */}
      <div className="w-full bg-white dark:bg-[#0f172a] border-b border-slate-200 dark:border-slate-800 py-16 px-4">
        <div className="max-w-4xl mx-auto text-center space-y-4">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-slate-100 dark:bg-[#1e293b] mb-4 border border-slate-200 dark:border-slate-700">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-72 shrink-0">
          <div className="sticky top-24 bg-white dark:bg-[#0f172a] rounded-2xl border border-slate-200 dark:border-slate-800 p-4 space-y-1 shadow-sm">
            {navItems.map((item) => (
              <button
                key={item.id}
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-bold rounded-xl transition-all text-left ${
                  activeSection === item.id 
                    ...
                    : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:bg-[#1e293b] dark:hover:bg-slate-800'
                }`}
              >
        ...
        <div className="flex-1 min-w-0">
          <div className="bg-white dark:bg-[#0f172a] rounded-2xl border border-slate-200 dark:border-slate-800 p-6 md:p-10 shadow-sm min-h-[500px]">
            ...
            {activeSection === 'identitas' && (
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="bg-slate-50 dark:bg-[#020617] rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
                  <div className="divide-y divide-slate-200 dark:divide-slate-800">
                    {[
                      ...
                      <div key={idx} className="flex flex-col sm:flex-row sm:items-center p-4 hover:bg-white dark:bg-[#0f172a] dark:hover:bg-slate-900 transition-colors">
