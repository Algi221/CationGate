          ...
          <div className="lg:col-span-5 bg-[#0E1726] text-white p-8 md:p-12 flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-8">
              ...
              <div className="space-y-4">
                {/* Telepon */}
                <a href="https://wa.me/6285167348039" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 rounded-2xl bg-[#1B2739] border border-slate-700/50 transition-all hover:border-yellow-400/40 cursor-pointer group">
                  ...
                  <div>
                    ...
                    <span className="text-sm font-bold text-white tracking-wide group-hover:text-yellow-400 transition-colors">+62 851-6734-8039</span>
                  </div>
                </a>

                {/* Email */}
                <a href="mailto:cationgate@gmail.com" className="flex items-center gap-4 p-4 rounded-2xl bg-[#1B2739] border border-slate-700/50 transition-all hover:border-yellow-400/40 cursor-pointer group">
                  <div className="w-10 h-10 rounded-full bg-zinc-900 border border-zinc-800 text-white flex items-center justify-center shrink-0 shadow-md group-hover:bg-yellow-400/10 transition-colors">
                    <Mail size={16} className="text-yellow-400" />
                  </div>
                  <div>
                    <span className="text-xs font-semibold text-slate-400 block">Email Resmi</span>
                    <span className="text-sm font-bold text-white tracking-wide group-hover:text-yellow-400 transition-colors">cationgate@gmail.com</span>
                  </div>
                </a>
              </div>
            </div>
            ...
            <div className="relative z-10 flex items-center justify-center mt-12 w-full">
              <Image 
                src="/assets/lottie_ilustration/customer-service-executive.svg" 
                alt="Customer Service Executive"
                width={380}
                height={380}
                className="w-full max-w-[320px] md:max-w-[380px] opacity-90 drop-shadow-2xl -scale-x-100"
                priority
              />
            </div>
