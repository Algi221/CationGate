    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white flex flex-col justify-between">
      ...
      <main className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full space-y-20 flex-1">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50 dark:bg-blue-950/60 border border-blue-200 dark:border-blue-800 text-blue-600 dark:text-blue-400 text-[10px] font-extrabold uppercase tracking-wider">
            <Sparkles size={14} /> Tentang CationGate
          </div>
          <h1 className="text-[42px] md:text-[68px] font-black tracking-tight text-slate-900 dark:text-white">
            Membangun masa depan digital pendidikan Indonesia.
          </h1>
          <p className="text-[26px] text-slate-600 dark:text-slate-300 leading-relaxed">
        ...
        <section id="visi-misi" className="scroll-mt-32 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xl space-y-4">
            ...
            <h2 className="text-[26px] font-extrabold">Visi Kami</h2>
          ...
          <div className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xl space-y-4">
            ...
            <h2 className="text-[26px] font-extrabold">Misi Kami</h2>
            <p className="text-slate-600 dark:text-slate-300 text-base leading-relaxed">
        ...
        <section id="tim" className="scroll-mt-32 space-y-8">
          <div className="text-center space-y-2">
            <h2 className="text-[42px] font-black">Tim & Pendidik Kunci</h2>
            <p className="text-slate-500 text-base">Orang-orang di balik inovasi tiada henti CationGate.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              { name: "Husein", role: "Core Contributor", bg: "bg-amber-50 dark:bg-slate-800" },
            ].map((member, i) => (
              <div key={i} className={`p-6 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-md flex flex-col items-center text-center space-y-3 ${member.bg}`}>
                ...
                />
                <h3 className="font-extrabold text-[26px]">{member.name}</h3>
                <span className="text-[10px] font-bold uppercase tracking-wider text-blue-600 dark:text-blue-400">{member.role}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section id="kisah" className="scroll-mt-32 p-8 md:p-12 rounded-3xl bg-slate-900 text-white space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-[26px] md:text-[42px] font-black">Kisah CationGate</h2>
          </div>
