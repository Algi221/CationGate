...
export function ContactScreen() {
  return (
    <section className="w-full px-4 md:px-6 py-16 md:py-24 max-w-6xl mx-auto flex justify-center items-center overflow-hidden">
      {/* Main Rounded Box */}
      <motion.div
        ...
        className="relative w-full bg-white rounded-[2.5rem] shadow-[0_20px_60px_rgba(0,0,0,0.08)] overflow-hidden flex min-h-[400px] md:min-h-[450px]"
      >
        ...
        <div className="relative z-10 w-full flex flex-col md:flex-row items-center justify-between px-8 py-12 md:px-16 md:py-0">
          <div className="w-full md:w-3/5 flex flex-col items-start text-left mb-12 md:mb-0">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-0 py-1.5 text-white/90 text-sm font-bold tracking-widest mb-4"
            >
              Bantuan & Diskusi
            </motion.div>
          ...
          <div className="w-full md:w-2/5 flex justify-center md:justify-end items-center relative">
            ...
            >
              ...
              {/* Animasi mengambang (looping) dihapus, hanya menyisakan gambar statis setelah animasi masuk selesai */}
