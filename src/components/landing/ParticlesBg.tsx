...
export function ParticlesBg() {
  return (
    <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden opacity-40">
      ...
      {/* Soft ambient highlight that follows the SPMB warm brand language */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-gradient-to-b from-[#F3C625]/40 via-[#8EC9F6]/20 to-transparent blur-3xl rounded-full" />
    </div>
  );
}
