...
export function PartnersSection() {
  ...
  return (
    <section className="py-10 bg-transparent relative overflow-hidden">
      ...
      {/* Edge Fades untuk efek seamless marquee */}
      <div className="pointer-events-none absolute inset-0 z-10 h-full w-full bg-linear-to-r from-white via-transparent to-white dark:from-slate-950 dark:via-transparent dark:to-slate-950"></div>
