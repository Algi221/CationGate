...
const steps = [
  {
    ...
    desc: "Daftarkan akun sekolah Anda. Mulai dari sistem yang terpadu.",
    bg: "bg-[#FAF8F5]",
    text: "text-[#2e3749]",
    direction: "bottom",
    layout: "image-left",
  ...
  },
  {
    id: "02",
    title: "Login",
    desc: "Masukkan nama untuk halaman pendaftaran sekolah Anda. Buat identitas yang mudah dikenali.",
    bg: "bg-white",
    text: "text-[#2e3749]",
    direction: "right",
    layout: "image-right",
    image: "/assets/flow/akun.png",
  ...
  },
  {
    ...
    direction: "bottom",
    layout: "image-left",
    image: "/assets/flow/verifikasi.png",
    waveColor: "text-[#FFD33B]/20",
  },
  {
    id: "04",
    ...
    direction: "right",
    layout: "image-right",
    image: "/assets/flow/payment1.png",
  ...
  },
  {
    ...
    direction: "bottom",
    layout: "image-left",
    image: "/assets/flow/ui.png",
    waveColor: "text-[#2e3749]/15",
  },
];

// OPTIMASI: WaveDecoration dibungkus React.memo agar tidak re-render saat user scroll
const WaveDecoration = memo(
  ({ colorClass, flip }: { colorClass: string; flip: boolean }) => (
    <div
...
// OPTIMASI: StepCard dibungkus React.memo agar tidak ikut nge-render ulang komponen React (cukup Framer Motion yg jalan di background)
const StepCard = memo(
  ({
    step,
    index,
    ...
    if (step.direction === "right") initialX = "100vw";
    if (step.direction === "bottom") initialY = "100vh";
    ...
    const visibility = useTransform(smoothProgress, (p) =>
      p < startVisible - 0.02 ? "hidden" : "visible",
    );
          ...
          <div className="w-full h-full max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-center md:justify-between gap-6 md:gap-16 px-6 md:px-16 pt-24 md:pt-0 relative z-10">
            ...
            <div className="w-full md:w-[42%] lg:w-[38%] flex flex-col justify-center space-y-3 md:space-y-6 relative">
              <div className="flex items-baseline gap-3 md:gap-4">
                ...
                <span
                  className={`font-black leading-none tracking-tighter opacity-90 ${
                    step.id === "01"
                      ? "text-5xl md:text-7xl lg:text-8xl"
                      : "text-6xl md:text-[10rem] lg:text-[12rem]"
                  }`}
                >
                  {step.id}
                </span>
    ...
    return (
      <motion.div
        style={{
          ...
          zIndex: index + 10,
          visibility,
          // OPTIMASI PALING KUNCI: `contain: "strict"` mencegah browser melakukan kalkulasi ulang layout halaman lain saat elemen ini bergerak.
          contain: "strict",
        }}
        className={`absolute inset-0 h-[100dvh] w-full flex items-center justify-center overflow-hidden ${step.bg} ${step.text} border-t border-black/5 shadow-none md:shadow-2xl`}
      >
...
export default function SystemFlowSection() {
  ...
  const smoothProgress = useSpring(scrollYProgress, {
    ...
    damping: 30,
    mass: 0.1,
    // OPTIMASI: Menambahkan restSpeed untuk mempercepat waktu stop kalkulasi spring saat scroll berhenti.
    restSpeed: 0.001,
    restDelta: 0.001,
  });
  ...
  return (
    <div ref={containerRef} className="relative h-[1500vh] w-full bg-[#FAF8F5]">
      <div className="sticky top-0 h-[100dvh] w-full overflow-hidden">
        {/* HERO SECTION */}
        <div
          className="absolute inset-0 h-[100dvh] w-full bg-[#FAF8F5] text-[#2e3749] z-0 flex flex-col justify-between p-6 md:p-16 overflow-hidden"
          style={{ contain: "strict" }} // Isolasi Hero Section juga
        >
