  ...
  const steps = [
    {
      ...
      bg: "bg-[#FF5A1F]", // Oranye persis gambar
      text: "text-white",
    },
    {
      num: "02",
      ...
      bg: "bg-[#111111]", // Hitam pekat persis gambar
      text: "text-white",
    },
    {
      num: "03",
      ...
      bg: "bg-[#F3EFEA]", // Off-white/Cream persis gambar
      text: "text-[#111111]", // Teks hitam
    },
    {
      num: "04",
      label: "AKTIVASI",
    ...
    <section className="relative w-full bg-slate-50">
      ...
      <div className="py-24 text-center max-w-3xl mx-auto px-4 space-y-4">
        ...
        <p className="text-slate-600 text-lg leading-relaxed font-medium">
          Proses transparan dan mulus dari pendaftaran awal hingga aktivasi penuh platform.
        </p>
      </div>
