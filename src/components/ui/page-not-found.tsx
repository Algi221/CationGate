...
function MessageDisplay() {
  ...
  return (
    <div className="absolute flex flex-col justify-center items-center w-[90%] h-[90%] z-[100]">
      ...
      >
        <div className="text-[35px] font-semibold text-white m-[1%] drop-shadow-md">
          Page Not Found
        </div>
        <div className="text-[80px] font-bold text-white m-[1%] drop-shadow-lg">
          404
        </div>
        <div className="text-[15px] w-1/2 min-w-[40%] text-center text-white m-[1%] drop-shadow-md">
          The page you are looking for might have been removed, had its name changed, or is temporarily unavailable.
        </div>
        <div className="flex gap-6 mt-8">
          <button
            onClick={() => router.back()}
            className="text-white border-2 border-white hover:bg-white hover:text-black transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105 rounded-xl cursor-pointer"
          >
          ...
          <Link
            href="/"
            className="bg-white text-black hover:bg-gray-200 transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105 rounded-xl cursor-pointer shadow-lg"
          >
